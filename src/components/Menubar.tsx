...
import { ReactComponent as ChevronIcon } from "../assets/images/icons/ChevronRightIcon.svg";
...
const Menubar = () => {
  ...
  return (
    <div className="h-24 w-full flex items-center px-6 lg:px-10 xl:px-20">
      {/* Menu */}
      <div className="relative w-full h-full flex shrink overflow-x-auto">
        <div
        ...
        {/* Floating Button */}
        <div className="absolute right-0 flex items-center justify-end w-16 h-full bg-gradient-to-r from-transparent to-black">
          <button
